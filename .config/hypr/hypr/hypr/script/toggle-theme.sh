...
if [ $current = "mocha" ]; then
    ...
    swww img ~/Pictures/Wallpaper/latte.png --transition-type wipe --transition-angle 30 --transition-fps 60
    ...
    swww img ~/Pictures/Wallpaper/mocha.png --transition-type wipe --transition-angle 30 --transition-fps 60
